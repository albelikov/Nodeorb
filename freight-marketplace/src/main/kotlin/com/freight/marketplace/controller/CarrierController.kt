...
import com.freight.marketplace.service.TrustTokenService
import com.freight.marketplace.service.TrustTokenService.TokenInfo
...
class CarrierController(
    ...
    fun getTrustToken(
        ...
        val tokenData = activeTokens.find { it.masterOrderId == orderId }
        
        return if (tokenData != null) {
            ResponseEntity.ok(
                TrustTokenInfo(
                    token = tokenData.tokenId, // Используем tokenId как токен

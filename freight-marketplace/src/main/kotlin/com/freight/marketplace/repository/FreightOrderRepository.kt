...
interface UserProfileRepository : JpaRepository<UserProfileEntity, UUID> {
    ...
    /**
     * Поиск профилей с количеством заказов больше или равным указанному
     */
    fun findByTotalOrdersGreaterThanEqual(totalOrders: Int, pageable: Pageable): Page<UserProfileEntity>
    
    /**
     * Поиск профилей по имени компании (нечувствительно к регистру)
     */
    fun findByCompanyNameContainingIgnoreCase(companyName: String, pageable: Pageable): Page<UserProfileEntity>
    
    /**
     * Средний рейтинг всех профилей
     */
    @Query("""

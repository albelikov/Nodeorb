...
import com.freight.marketplace.service.notification.NotificationRouterService
import com.freight.marketplace.service.notification.NotificationSender
import com.freight.marketplace.service.notification.Priority
import com.freight.marketplace.service.notification.Channel
...
return ResponseEntity.ok(mapOf<String, Any>(
    ...
    fun sendWithUserPreferences(
        ...
        try {
            val notification = com.freight.marketplace.service.notification.Notification(
                userId = userId,
                priority = priority,
                channels = channels,
                templateKey = templateKey,

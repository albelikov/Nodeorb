...
import com.freight.marketplace.gateway.MarketplaceGateway
import com.freight.marketplace.service.OrderService
import com.freight.marketplace.service.OrderExecutionService
...
class WebSocketConfig : WebSocketConfigurer {
    ...
    fun marketplaceGateway(): MarketplaceGateway {
        return MarketplaceGateway(orderService, orderExecutionService)
    }
...
class AuthenticationHandshakeInterceptor : HandshakeInterceptor {
    ...
    companion object {
        private val logger = Logger.getLogger(AuthenticationHandshakeInterceptor::class.java.name)
    }

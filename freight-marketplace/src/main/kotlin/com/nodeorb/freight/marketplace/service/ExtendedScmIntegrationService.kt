...
class ExtendedScmIntegrationService(
    ...
    fun checkCarrierComplianceWithADR(
        ...
        val complianceStatus = when (policyResult.status) {
            com.nodeorb.freight.marketplace.service.ComplianceStatus.COMPLIANT -> "COMPLIANT"
            com.nodeorb.freight.marketplace.service.ComplianceStatus.WARNING -> "COMPLIANT_WITH_WARNINGS"
            com.nodeorb.freight.marketplace.service.ComplianceStatus.VIOLATION -> "NON_COMPLIANT"
        }

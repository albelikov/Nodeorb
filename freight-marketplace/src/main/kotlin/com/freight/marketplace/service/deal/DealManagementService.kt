package com.freight.marketplace.service.deal
...
class DealManagementService(
    ...
    fun awardBid(bidId: UUID): BidEntity {
        ...
        masterOrder.status = com.freight.marketplace.entity.OrderStatus.IN_PROGRESS
    ...
    fun cancelAward(bidId: UUID): BidEntity {
        ...
        masterOrder.status = com.freight.marketplace.entity.OrderStatus.AUCTION_ACTIVE
        masterOrderRepository.save(masterOrder)
        
        // 7. Отменяем статус ставки
        bid.status = com.freight.marketplace.entity.BidStatus.PENDING
        bid.updatedAt = java.time.LocalDateTime.now()
        val updatedBid = bidRepository.save(bid)
     ...
     */
    @Transactional
    fun markTransportationStarted(bidId: UUID): com.freight.marketplace.entity.deal.ContractEntity {
     ...
     */
    @Transactional
    fun completeDeal(bidId: UUID, evidenceHash: String? = null): com.freight.marketplace.entity.deal.ContractEntity {
     ...
     */
    @Transactional
    fun initiateDispute(bidId: UUID, reason: String): com.freight.marketplace.entity.deal.ContractEntity {

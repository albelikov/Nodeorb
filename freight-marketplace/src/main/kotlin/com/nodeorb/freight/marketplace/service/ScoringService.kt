...
import com.nodeorb.freight.marketplace.dto.PriceScoreDetails
import com.nodeorb.freight.marketplace.dto.TrustScoreDetails
import com.nodeorb.freight.marketplace.dto.SLAScoreDetails
import com.nodeorb.freight.marketplace.dto.GeoScoreDetails
import com.nodeorb.freight.marketplace.entity.BidEntity
import com.nodeorb.freight.marketplace.entity.ScmSnapshotEntity
...
import com.nodeorb.freight.marketplace.service.insight.RouteInfo
...
class ScoringService(
    ...
    private fun calculateTrustScore(bid: BidEntity): Double {
        ...
        when (snapshot.complianceStatus) {
            com.nodeorb.freight.marketplace.entity.ComplianceStatus.NON_COMPLIANT -> trustScore *= 0.5
            com.nodeorb.freight.marketplace.entity.ComplianceStatus.EXPIRED -> trustScore *= 0.7
            else -> {} // COMPLIANT и PENDING не влияют
        }
        
        // Понижение за низкий уровень безопасности
        when (snapshot.securityClearance) {
            com.nodeorb.freight.marketplace.entity.SecurityLevel.NONE -> trustScore *= 0.8
            com.nodeorb.freight.marketplace.entity.SecurityLevel.CONFIDENTIAL -> trustScore *= 0.9
